"""fixed team-user link

Revision ID: db31196af850
Revises: 56562cb56ba2
Create Date: 2024-04-05 23:22:23.359162
...
revision: str = 'db31196af850'
down_revision: Union[str, None] = '56562cb56ba2'
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name='userteam_pkey')
    )
